...
<img width="1350" height="297" alt="image" src="https://github.com/user-attachments/assets/35b5c471-6bda-4aa5-b4de-93757cdec924" />
...
<span class="cmd">nmap</span> <span class="fl">-sn</span> <span class="val">192.168.1.0/24</span>  <span class="c"># Ping sweep — host discovery only</span></pre>
    ...
    <div class="code-block">
      <div class="code-header">
        <span class="dot dot-r"></span><span class="dot dot-y"></span><span class="dot dot-g"></span>
        <span class="code-label">SERVICE & OS DETECTION</span>
      </div>
      <pre><span class="cmd">nmap</span> <span class="fl">-sV</span> <span class="val">192.168.1.1</span>  <span class="c"># Service version detection</span>
